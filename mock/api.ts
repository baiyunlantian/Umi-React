...
export default {// 支持值为 Object 和 Array

  'POST /mock/user/doLogin': ({body}:any, res:any) => {
    // 添加跨域请求头
  ...
  //获取总校区--校区人数
  'POST /mock/getCampusTotalPerson': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
  ...
  //获取总校区--考勤人数
  'POST /mock/getCampusTotalAttendance': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取总校区--体温统计
  'POST /mock/getCampusTotalAnimalHeat': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取总校区数据--访客统计
  'POST /mock/getCampusTotalVisitor': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取某校区--实时在校人数
  'POST /mock/getCampusPerson': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取某校区--实时访客统计
  'POST /mock/getCampusVisitor': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取某校区--实时考勤统计
  'POST /mock/getCampusAttendance': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取某校区--实时体温统计
  'POST /mock/getCampusAnimalHeat': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取某校区--实时异常体温统计
  'POST /mock/getCampusExceptionAnimalHeat': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //获取总校区的校区列表
  'POST /mock/getCampusList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    const data = mockjs.mock({
  ...
  //删除校区信息
  'POST /mock/scene/delCampus': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //更新校区信息
  'POST /mock/scene/updateCampus': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //新增校区信息
  'POST /mock/scene/addCampus': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //场景管理--获取校区列表里
  'POST /mock/scene/findCampus': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
  ...
  //异常查询--信息统计
  'POST /mock/getExceptionInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //异常查询--角色分析
  'POST /mock/getExceptionRoleAnalyze': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //异常查询--人员信息列表
  'POST /mock/exceptionQuery/selectList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //异常查询--人员信息详情
  'POST /mock/getExceptionPersonDetail': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //异常查询--修改人员信息状态
  'POST /mock/exceptionQuery/update': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //异常查询--删除人员信息
  'POST /mock/delExceptionPerson': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //健康管理--今日体温统计
  'POST /mock/getHealthLeft': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //健康管理--今日体温角色分析
  'POST /mock/getHealthRight': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //健康管理--人员列表
  'POST /mock/health/animalHeatPersonList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
        ...
        'list|10':[
          {
            ...
            'ipNum':/[0-9]{18}/,
            'temp|36-39.1':36.0,
            'checkTime':mockjs.mock('@datetime'),
            'bodyState|0-1':1,
            'roleId|1-4':1,
            'roleName|+1':['学生','教师','访客','后勤'],
            'personId|1-1000':1
          }
        ],
        'page':{
  ...
  //健康管理--删除人员信息
  'POST /mock/delHealthPersonInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //健康管理--查看人员详情
  'POST /mock/getHealthPersonDetail': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //健康管理--获取体温趋势图
  'POST /mock/getPersonAnimalHeatList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //访客管理--实时访客统计
  'POST /mock/getRealTimeVisitorInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //访客管理--待审核信息列表
  'POST /mock/visitor/WaitAuditList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //访客管理--来访信息列表
  'POST /mock/visitor/VisitorList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //访客管理--预约信息列表
  'POST /mock/visitor/AppointmentList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //考勤管理--考勤信息统计
  'POST /mock/getAttendanceInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //考勤管理--考勤信息统计
  'POST /mock/ruleAttendance/timeArrangeSelectList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //考勤管理--校园人员列表
  'POST /mock/attendance/personInCampusAttendanceList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //考勤管理--考勤查询--班级信息
  'POST /mock/getAttendanceClassInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //考勤管理--考勤查询--班级学生列表
  'POST /mock/getAttendanceStudentList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //考勤管理--个人考勤详情
  'POST /mock/getAttendancePersonDetail': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //考勤管理--个人考勤详情列表
  'POST /mock/getAttendancePersonList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //人员管理--人员统计
  'POST /mock/getPersonStatistics': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //人员管理--人员列表
  'POST /mock/person/personList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //人员管理--获取人员详情信息
  'POST /mock/getPersonDetailInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //人员管理--新增后勤
  'POST /mock/addLogistics': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //人员管理--新增老师(班主任)
  'POST /mock/addHeadTeacher': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //人员管理--新增老师(学校领导)
  'POST /mock/addSchoolLeader': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //人员管理--新增学生
  'POST /mock/addStudent': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--班级统计信息
  'POST /mock/getClassStatisticsInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--级部列表
  'POST /mock/findDepartment': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--全年级全班级列表信息
  'POST /mock/getAllClassList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--获取初(高)中部的年级信息
  'POST /mock/getGradeList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--添加信息
  'POST /mock/addClass': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--获取年级下的班级信息列表
  'POST /mock/getClassList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
  ...
  //班级管理--班级信息详情
  'POST /mock/getClassDetail': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
  ...
  //班级管理--班级详情--学生信息列表
  'POST /mock/getClassStudentList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
  ...
  //班级管理--查看学生详情
  'POST /mock/getStudentDetailInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
  ...
  //班级管理--人员库中未绑定班级的学生列表
  'POST /mock/getNotBindStudentList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log('studentId',body);
  ...
  //班级管理--修改学生信息
  'POST /mock/updateStudentInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--删除学生信息
  'POST /mock/delStudent': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //班级管理--删除班级信息
  'POST /mock/delClass': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //设备管理-设备统计信息
  'POST /mock/getDeviceStatisticsInfo': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //设备管理-设备列表信息
  'POST /mock/getDeviceList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //设备管理-设备详情轮播图
  'POST /mock/getDeviceSlideList': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //设备管理-修改语音提示
  'POST /mock/updateVoice': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
  ...
  //设备管理-设置轮播图显示
  'POST /mock/terminal/slideshowSetShow': ({body}:any, res:any) => {
    // 添加跨域请求头
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.setHeader( "Content-Type","text/html;charset=utf-8");
    console.log(body);
